...
/**
 * A pairing beteween a String {@code date}, a Sunday, and {@code total}
 * which is a trailing total from the last 6 days (Monday - Sunday).
 */
public final class WeekInfo {
  ...
  /**
   * Evaluates if two {@code WeekInfo} objects are equal based on their
   * (@code date} and {@code total} values.
